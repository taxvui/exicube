...
export default function LoginScreen(props) {
    ...
    return (
        ...
        <View style={[styles.container,{backgroundColor: mode === 'dark' ? colors.WHITE : colors.WHITE}]}>
            <ImageBackground
                source={mode === 'dark' ? require('../../assets/images/bg-dark.jpg') : require('../../assets/images/bg.jpg')}
                resizeMode="stretch"
            ...
            <View style={{ height: "35%", justifyContent: 'center', alignItems: 'center', position: "relative",flex:1 }}  >
                <View style={styles.header}  >
                    {langSelection && languagedata && languagedata.langlist && languagedata.langlist.length > 1 ?
                        <View style={[styles.headLanuage, [isRTL ? { left: 20 } : { right: 20 }],{borderColor: colors.SHADOW}]}>
                            <Text style={{ color: mode === 'dark' ? colors.WHITE : colors.BLACK, marginLeft: 3, fontFamily: fonts.Regular }}>{t('lang1')}</Text>
                            <RNPickerSelect
                                ...
                                style={{
                                    inputIOS: [styles.pickerStyle1,{ textAlign: isRTL ? "right" : "left", color: mode === 'dark' ? colors.WHITE : colors.BLACK, backgroundColor: mode === 'dark' ? colors.BLACK : colors.WHITE }],
                                    inputAndroid: [{textAlign: isRTL ? "right" : "left", color: mode === 'dark' ? colors.WHITE : colors.BLACK, backgroundColor: mode === 'dark' ? colors.BLACK : colors.WHITE }],
                                    placeholder: {
                                        color: 'white'
                                    },
                ...
                <ScrollView style={{ width: "100%", }}>
                    <View style={{ width: '100%', height: '100%', alignItems: 'center', flex: 1, }}  >
                        ...
                        {!isNaN(state.contact) && settings.mobileLogin ?
                            <View style={[styles.box1]}>
                                <RNPickerSelect
                                    ...
                                    style={{
                                        inputIOS: [styles.pickerStyle, { textAlign: isRTL ? "right" : "left", color: mode === 'dark' ? colors.WHITE : colors.BLACK, backgroundColor: mode === 'dark' ? colors.BLACK : colors.WHITE }],
                                        inputAndroid: [styles.pickerStyle, { textAlign: isRTL ? "right" : "left", color: mode === 'dark' ? colors.WHITE : colors.BLACK, backgroundColor: mode === 'dark' ? colors.BLACK : colors.WHITE }],
                                    }}
                        ...
                        <View style={[styles.box2,]}>
                            <TextInput
                                style={[styles.textInput, { textAlign: isRTL ? "right" : "left", color: mode === 'dark' ? colors.WHITE : colors.BLACK }]}
                        ...
                        {isNaN(state.contact) || (settings.emailLogin && !settings.mobileLogin) ?
                            <View style={[styles.passwordBox, { flexDirection: isRTL ? 'row-reverse' : 'row', alignItems: 'center', }]}>
                                <TextInput
                                    style={[styles.pasWordText,{paddingRight:isRTL?10:0},  { textAlign: isRTL ? "right" : "left", color: mode === 'dark' ? colors.WHITE : colors.BLACK }]}
                            ...
                            <View style={{ flexDirection: 'row', justifyContent: 'space-around', marginTop: 10}}>
                                {state.verificationId || isNaN(state.contact) ?
                                    <TouchableOpacity style={styles.actionItem} onPress={CancelLogin}>
                                        <Text style={[styles.actionText, {color: mode === 'dark' ? colors.WHITE : colors.BLACK}]}>{t('cancel')}</Text>
                                    </TouchableOpacity>
                                : null}
                                {isNaN(state.contact) ?
                                    <TouchableOpacity style={styles.actionItem} onPress={forgotPassword}>
                                        <Text style={[styles.actionText, {color: mode === 'dark' ? colors.WHITE : colors.BLACK}]}>{t('forgot_password')}</Text>
                                    </TouchableOpacity>
                                : null}
                            </View>
                        : null}
                        ...
                        {settings.socialLogin ?
                            <View style={styles.seperator}>
                                ...
                                <View style={styles.lineLeftFiller}>
                                    <Text style={[styles.sepText, {color: mode === 'dark' ? colors.WHITE : colors.BLACK}]}>{t('spacer_message')}</Text>
                                </View>
                        ...
                        <View style={[styles.footer,{flexDirection: isRTL ? "row-reverse" : 'row',}]}>
                            <TouchableOpacity style={[styles.terms]} onPress={openRegister}>
                                <Text style={[styles.actionText,{fontSize:13, color: mode === 'dark' ? colors.WHITE : colors.BLACK}]}>{t('register_as_driver')}</Text>
                            </TouchableOpacity>
                            <TouchableOpacity style={styles.terms} onPress={openTerms}>
                                <Text style={[styles.actionText,{fontSize:13, color: mode === 'dark' ? colors.WHITE : colors.BLACK}]}>{t('terms')}</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
                </ScrollView>
